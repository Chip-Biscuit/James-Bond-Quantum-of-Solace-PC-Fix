...
If modmenu = 1 you are unable to use previous saves but if modmenu = 0 saves work just fine make sure if you will be enabling the mod menu to back up any saves you have before use. 
